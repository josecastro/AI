...
factor['p(x1)'] = bayes.Factor(vars=[x2], values=[0.11, 0.89])
...
factor['marginal'] = bayes.Factor(vars=[x1], values=[1.0, 1.0])
...
factor['e2'] = bayes.Factor(vars=[x2,x1], values=[0.59, 0, 0.22, 0])
factor['e3'] = bayes.Factor(vars=[x3,x2], values=[0, 0.61, 0, 0])
